...
Patch29: busybox-1.15.1-cpio.patch
Patch30: busybox-1.15.1-awk.patch
Patch31: busybox-1.15.1-hush2.patch
Patch32: busybox-1.15.1-grep.patch
Patch33: busybox-1.15.1-btrfs.patch
Patch34: busybox-1.15.1-hush3.patch
Patch35: busybox-1.15.1-udhcp.patch
...
* Fri Apr  6 2012 Denys Vlasenko <dvlasenk@redhat.com> - 1:1.15.1-15
- Fix btrfs support to findfs and related applets
- Resolves: #751927

* Mon Mar 26 2012 Denys Vlasenko <dvlasenk@redhat.com> - 1:1.15.1-14
- Resolves: #790335 "busybox various flaws"
  Added a fix for SEGV on empty command in hush

* Wed Feb 29 2012 Denys Vlasenko <dvlasenk@redhat.com> - 1:1.15.1-13
...
* Tue Jan 17 2012 Denys Vlasenko <dvlasenk@redhat.com> - 1:1.15.1-12
- Backport 'set -o pipefail' support
- Resolves: #782018
- Add btrfs support to findfs and related applets
- Resolves: #751927

* Tue Nov 30 2010 Denys Vlasenko <dvlasenk@redhat.com> - 1:1.15.1-11
- Fix cpio applet to print "N blocks" to stderr, not stdout
- Change .config, making hwclock read adjtime from correct location:
  /etc/adjtime
- Fix awk to correctly interpret numbers with leading zeros: 02.345
- Resolves: #615391, #621853, #633961
